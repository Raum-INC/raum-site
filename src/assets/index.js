export const Assets = {
  ...
  wifi: require("../assets/wifi.svg").default,
  swimming: require("../assets/swimming.svg").default,
  bath: require("../assets/bath.svg").default,
  ...
  guestHero: require("../assets/guestHero.png"),
  ...
  popular_locations_1: require("../assets/popular_locations_1.png"),
  popular_locations_2: require("../assets/popular_locations_2.jpg"),
  popular_locations_3: require("../assets/popular_locations_3.png"),
  popular_locations_4: require("../assets/popular_locations_4.png"),
  advanceBooking: require("../assets/advanceBooking.png"),
  service_1: require("../assets/service_1.png"),
  service_2: require("../assets/service_2.png"),
  service_3: require("../assets/service_3.png"),
  service_4: require("../assets/service_4.png"),
  service_5: require("../assets/service_5.png"),
  service_6: require("../assets/service_6.png"),
  reserveSteps: require("../assets/reserveSteps.png"),
