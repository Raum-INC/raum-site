        ...
        <>
          <div className="w-full h-screen fixed top-20 overflow-hidden z-30">
            <motion.div
              ...
              animate="visible"
              exit="hidden"
              className="w-full h-[90%] fixed flex flex-col bg-black border-2 border-primary p-4 md:p-8 md:px-12 rounded-t-3xl z-40"
            >
              <div className="relative">
                ...
                <form action="/">
                  <div className="flex flex-col justify-center items-center gap-5">
                    ...
                    <div className="w-full md:w-4/5 flex flex-col justify-center items-center gap-3 md:gap-10">
